...
gulp.task("watch", function() {
  ...
  gulp.watch(
    ["bower_components/*", `${SCRIPT_PATH}/*.js`],
    ["scripts", "cleanup"]
  );
  gulp.watch(["docs/master.html", "docs/master.min.js", "docs/master.min.css"]);
});
